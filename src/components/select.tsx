...
export const Trigger = React.forwardRef<HTMLButtonElement, RadixSelect.SelectTriggerProps>(function Trigger(
  ...
  return (
    <RadixSelect.Trigger className={classNames(className, styles.trigger)} ref={ref} {...otherProps}>
      {children}
    </RadixSelect.Trigger>
  )
})
...
export const Viewport = React.forwardRef<HTMLDivElement, RadixSelect.SelectViewportProps>(function Viewport(
  ...
  return (
    <RadixSelect.Viewport className={classNames(className, styles.viewport)} ref={ref} {...otherProps}>
      {children}
